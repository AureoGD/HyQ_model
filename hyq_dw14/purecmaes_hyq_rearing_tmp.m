...
task = task_hyqrearingmotion_tmp(N);
...
% filename = 'rear_60_hyq2max_good1.mat';
%filename='mu7_jl_rearTesttmp_PD601_hyq2max_60_data_15-Aug-2016-15-53.mat';
...
clock_array = clock;
name_file= ['mu7_jl_rearTesttmp_PD601_hyq2max_' num2str(abs(rad2deg(task.final_RPY(2)))) '_data_' date '-' num2str(clock_array(4)) '-' num2str(clock_array(5)) ];
save(name_file);
