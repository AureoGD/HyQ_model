...
filename = 'mu6_SR_data_terrain_init_25-Aug-2016-12-1.mat';
% filename= 'mu7_jl_SR_data_terrain_init_06-Sep-2016-14-18.mat';
...
filename = ['mu66_jl_SR_data_terrain_init_' date '-' num2str(clock_array(4)) '-' num2str(clock_array(5)) ];
save(filename)
toc
...
[X,Xd,Q,RPY, ...
    ...
    time] = hyq_do_Rollout_right(out.datx(end,:),task,0);
...
[X,Xd,Q,RPY, ...
    th,thd,u,des_th,des_thd, ...
    LF_foot_pos,RF_foot_pos,LH_foot_pos,RH_foot_pos, ...
    time] = hyq_do_Rollout_right(out.datx(end,:),task,1);
