...
% load('/home/aradulescu/OneShot/hyq_dw14/Hyq2Max_SR/mu9_SR_data_terrain_init_30-Jul-2016-17-20.mat')
thetas = out.datx(end,:);
% [X,Xd,Q,RPY,th,thd,u,time] = hyq_do_Rollout_right_savefull(thetas,task,1);
