 ...
 * (c) 2000 Aurelio Medina
 * Source: http://sourceware.org/ml/pthreads-win32/2000/msg00131.html
 *
 *****************************************************************************/
#include <stdlib.h>
#include <stdio.h>
...
again:
    if (oflag & O_CREAT) {
        ...
        fd = _open(newpath, oflag | O_EXCL | O_RDWR, mode | S_IXUSR);
        if (fd < 0) {
            ...
            if ( (mqinfo = (mq_info*)malloc(sizeof(struct mq_info))) == NULL)
                goto err;
#if defined(WIN32)
