...
TARGET_LINK_LIBRARIES(${TARGET} odesim)
...
IF (NOT __ODESIM_CMAKE_INCLUDED)
  ...
  ADD_SUBDIRECTORY(${WORKSPACE_DIR}/dbl/platform/simulation/odesim ${WORKSPACE_DIR}/build/odesim/${CMAKE_BUILD_TYPE}${COMPILER_VERSION})
