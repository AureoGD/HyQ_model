...
void *Simulator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CGenericODESim"))
        return static_cast< CGenericODESim*>(const_cast< Simulator*>(this));
    if (!strcmp(_clname, "SimulationLog"))
        return static_cast< SimulationLog*>(const_cast< Simulator*>(this));
